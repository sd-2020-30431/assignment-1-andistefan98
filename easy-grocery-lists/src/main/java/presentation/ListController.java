...
public class ListController {
	...
	static void addNewItem(JFrame frmGroceryList,Optional<User> user, UserService service, GroceryListService listServ,GroceryList items , GroceryItemService itemServ ) {
		NewItemFrame frm = new NewItemFrame(user,service,items,listServ,itemServ);
		frm.setVisible(true);
		frmGroceryList.dispose();
	}
